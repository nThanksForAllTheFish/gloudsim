package fr.imag.mescal.optft.prepare;

import java.io.DataInputStream;
import java.net.ServerSocket;
import java.net.Socket;
import fr.imag.mescal.optft.comm.TCPClient;
import fr.imag.mescal.optft.sim.vmserver.VMServer;
...
public class EstRestartOverhead2 {
	...
	public static void main(String[] args)
	{
		...
		for(int i = minSize;i<=maxSize;i++)
		{
			...
			String cmdline = "cr_run java -XX:-UsePerfData -Xmx400m -cp lib/cpsim.jar fr.imag.mescal.optft.prepare.EstCPProgram ";
