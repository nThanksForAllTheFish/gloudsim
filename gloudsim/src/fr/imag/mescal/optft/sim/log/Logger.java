package fr.imag.mescal.optft.sim.log;
...
public class Logger {
	...
	public static void main(String[] args)
	{
		if(args.length!=4)
		{
			...
			System.out.println("Example: java fr.imag.mescal.optft.sim.log.Logger jobRealLength.log /localfs/contextNFS /cloudNFS/CheckpointSim/cpState result.txt");
			System.exit(0);
		}
